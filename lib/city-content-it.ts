...
export const cityContentsIT: Record<string, CityContent> = {
  lugano: {
    ...
    testimonial: {
      ...
      quote: 'Lugano offre le condizioni perfette per l\'energia solare. Il nostro impianto produce molto più di quanto avessimo previsto. Con Solarheim abbiamo ricevuto tre eccellenti offerte e abbiamo scelto quella migliore. Un servizio veramente consigliato!'
    }
  }
};
