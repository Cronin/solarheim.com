  ...
  zuerich: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Mit über 40 Solarteuren in Zürich ist die Auswahl riesig - aber auch unübersichtlich. Unsere Empfehlung: Holen Sie mindestens 3 Offerten ein und vergleichen Sie nicht nur Preise, sondern auch Garantien, verwendete Komponenten (Module, Wechselrichter) und Referenzen. SolarHeim vermittelt kostenlos bis zu 3 geprüfte Angebote von seriösen Zürcher Betrieben. Unsere Kunden sparen durch den Vergleich durchschnittlich 4.500-7.000 CHF - bei gleicher oder besserer Qualität.'
      },
      {
