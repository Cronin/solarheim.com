// German translations for solarheim.ch
export const de = {
  common: {
  ...
  footer: {
    ...
    copyright: '© 2024 Solarheim. Alle Rechte vorbehalten.',
  },
  testimonials: {
  ...
  meta: {
    homeTitle: 'Solarheim - Solaranlagen in der Schweiz vergleichen | Kostenlose Offerten',
