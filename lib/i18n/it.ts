// Italian translations for solarheim.ch
...
export const it: TranslationKeys = {
  ...
  footer: {
    ...
    legal: 'Legale',
    followUs: 'Seguici',
    copyright: '© 2024 Solarheim. Tutti i diritti riservati.',
  },
  testimonials: {
  ...
  meta: {
    homeTitle: 'Solarheim - Confronta impianti fotovoltaici in Svizzera | Preventivi gratuiti',
