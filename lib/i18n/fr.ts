// French translations for solarheim.ch
...
export const fr: TranslationKeys = {
  ...
  footer: {
    ...
    copyright: '© 2024 Solarheim. Tous droits réservés.',
  },
  testimonials: {
  ...
  meta: {
    homeTitle: 'Solarheim - Comparer les installations solaires en Suisse | Devis gratuits',
