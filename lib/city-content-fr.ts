...
export const cityContentsFR: Record<string, CityContent> = {
  genf: {
    ...
    testimonial: {
      initials: 'MD',
      name: 'Marie Dubois',
      quote: 'Genève offre d\'excellentes conditions pour l\'énergie solaire. Notre installation produit beaucoup plus que prévu. Avec Solarheim, nous avons reçu trois offres compétitives et choisi la meilleure. Un service vraiment recommandable!'
    }
  }
};
