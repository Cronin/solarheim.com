...
export const metadata: Metadata = {
  title: 'Impressum',
  description: 'Impressum und rechtliche Informationen zu Solarheim.',
};
    ...
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none">
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Angaben gemäss Art. 5 DSG</h2>

          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <p className="text-gray-900 font-semibold mb-4">Solarheim</p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Vertretungsberechtigte Person</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Mehrwertsteuer-Nummer</h2>
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Haftung für Inhalte</h3>
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Haftung für Links</h3>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Urheberrecht</h3>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Streitbeilegung</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Konzeption und Design</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Solarheim<br />
            Zürich, Schweiz
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Technische Umsetzung</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
