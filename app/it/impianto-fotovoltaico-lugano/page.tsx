...
import { cityContentsIT } from '@/lib/city-content-it';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Impianto fotovoltaico Lugano: miglior sito solare della Svizzera con 2.157 ore di sole! Confronta gratuitamente preventivi da installatori certificati in Ticino. Sovvenzioni Programma Energia fino al 45%. CHF 8.800-23.000, netto da 6.200 CHF.`,
    keywords: [
      'Impianto fotovoltaico Lugano',
      'Fotovoltaico Lugano',
      'Installatore solare Lugano',
      'Impianto fotovoltaico Ticino',
      'Programma Energia Ticino',
      'Pannelli solari Lugano',
      'Costi impianto fotovoltaico Lugano',
      'Impianto FV Lugano Ticino',
      'Impianto fotovoltaico 2157 ore sole',
    ],
    alternates: {
      canonical: 'https://solarheim.ch/it/impianto-fotovoltaico-lugano',
      languages: {
        'de-CH': 'https://solarheim.ch/solaranlage-lugano',
        'fr-CH': 'https://solarheim.ch/fr/installation-solaire-lugano',
        'it-CH': 'https://solarheim.ch/it/impianto-fotovoltaico-lugano',
      },
    },
    openGraph: {
      title: 'Impianto Fotovoltaico Lugano Ticino - Leader svizzero nel solare',
      description: '2.157 ore di sole! Lugano è il miglior sito solare della Svizzera. Confronta gratuitamente preventivi, fino al 45% di sovvenzioni. Ammortamento 4-5 anni.',
      url: 'https://solarheim.ch/it/impianto-fotovoltaico-lugano',
      type: 'website',
      locale: 'it_CH',
      siteName: 'SolarHeim',
    },
...
export default function LuganoItalianPage() {
  const city = getCityBySlug(citySlug);
  const content = cityContentsIT[citySlug];
            ...
            "itemListElement": [
              {
                ...
                "position": 1,
                "name": "Home",
                "item": "https://solarheim.ch/it"
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Impianto Fotovoltaico Lugano",
                "item": "https://solarheim.ch/it/impianto-fotovoltaico-lugano"
              }
            ]
          })
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "serviceType": "Installazione Fotovoltaico",
            "name": "Installazione Impianto Fotovoltaico Lugano",
            "description": "Installazione professionale di impianti fotovoltaici a Lugano, Ticino. Leader con 2.157 ore di sole.",
            "provider": {
              "@type": "LocalBusiness",
              "name": "SolarHeim",
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6">
              ...
              <span className="text-sm font-bold text-orange-600">
                2.157 ore di sole - Leader svizzero!
              </span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Impianto Fotovoltaico Lugano Ticino –{' '}
              <span className="text-orange-600">Migliori condizioni della Svizzera</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 max-w-3xl mx-auto">
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <div className="text-sm text-gray-600">Ore di sole/anno</div>
                <div className="text-xs text-gray-500 mt-1">Più di Zurigo</div>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="text-3xl font-bold text-green-600 mb-2">4-5</div>
                <div className="text-sm text-gray-600">Anni ammortamento</div>
                <div className="text-xs text-gray-500 mt-1">ROI rapido</div>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="text-3xl font-bold text-primary mb-2">45%</div>
                <div className="text-sm text-gray-600">Sovvenzioni possibili</div>
                <div className="text-xs text-gray-500 mt-1">Federale + Ticino</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />
                <span className="text-gray-700 font-medium">Installatori Ticino</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />
                <span className="text-gray-700 font-medium">Fino a 3 preventivi</span>
              </div>
            </div>

            <a href="#formular" className="btn-primary text-lg px-8 py-4">
              Richiedi ora preventivo gratuito
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom max-w-6xl">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-12 text-center">
            Costi Impianto Fotovoltaico a Lugano
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Costi di investimento</h3>
              </div>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <span className="text-gray-600">Impianto 5 kWp (tipico)</span>
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <span className="text-gray-600">Dopo sovvenzioni</span>
                ...
                <div className="pt-4 border-t">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700 font-semibold">Ammortamento</span>
                    <span className="text-xl font-bold text-primary">{content.pricing.roiYears} anni</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card bg-gradient-to-br from-orange-50 to-yellow-50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Vantaggio Lugano</h3>
              </div>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                  <div>
                    <div className="font-bold text-gray-900">6.500 kWh/anno</div>
                    <div className="text-sm text-gray-600">Impianto 5 kWp produce più che nell'altopiano</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                  <div>
                    <div className="font-bold text-gray-900">2.400 CHF/anno</div>
                    <div className="text-sm text-gray-600">Risparmio annuale grazie agli elevati rendimenti</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                  <div>
                    <div className="font-bold text-gray-900">38% più rendimento</div>
                    <div className="text-sm text-gray-600">vs. Zurigo grazie a 2.157 ore di sole</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Esempi di prezzo Lugano</h3>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="text-left py-3 px-4 text-gray-700">Dimensione impianto</th>
                    <th className="text-left py-3 px-4 text-gray-700">Costi lordi</th>
                    <th className="text-left py-3 px-4 text-gray-700">Dopo sovvenzioni</th>
                    <th className="text-left py-3 px-4 text-gray-700">Produzione/anno</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <div key={index} className="card hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Dimensione impianto:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Risparmio/anno:</span>
                    <span className="font-bold text-primary">{study.savings}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Ammortamento:</span>
      ...
      <section className="relative section-padding bg-gray-900 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Installazione impianto fotovoltaico Lugano Ticino"
            fill
        ...
        <div className="container-custom max-w-4xl relative z-10">
          <div className="text-center text-white">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
              Installazione professionale nel soleggiato Ticino
            </h2>
            <p className="text-xl text-white mb-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
              Installatori esperti da Lugano e dal Ticino installano il vostro impianto su misura
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="text-sm text-white/90 font-medium">Ore di sole</div>
              </div>
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">45%</div>
                <div className="text-sm text-white/90 font-medium">Sovvenzioni</div>
              </div>
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">4-5</div>
                <div className="text-sm text-white/90 font-medium">Anni ROI</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom max-w-6xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Installatori solari a Lugano e dintorni
            </h2>
            <p className="text-gray-600">
              La nostra rete comprende aziende certificate in tutta la regione del Ticino
            </p>
          </div>

          <div className="relative rounded-2xl overflow-hidden shadow-xl h-[500px]">
            <iframe
              src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyDQF_fL_qx_1QZVlvJFNRl5ETBhjcJOFAE&q=Lugano,Svizzera&zoom=12`}
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
        ...
        <div className="container-custom max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Richiedi preventivi gratuiti per Lugano
            </h2>
            <p className="text-xl text-gray-600">
              Ricevi fino a 3 offerte da installatori locali in Ticino
            </p>
          </div>
          <FormContainer />
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Lugano, Ticino</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-gradient-to-r from-orange-500 to-yellow-500 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            Approfitta delle 2.157 ore di sole a Lugano!
          </h2>
