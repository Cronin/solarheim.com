...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: 'https://solarheim.ch/fr/installation-solaire-geneve',
      languages: {
        'de-CH': 'https://solarheim.ch/solaranlage-genf',
        'fr-CH': 'https://solarheim.ch/fr/installation-solaire-geneve',
        'it-CH': 'https://solarheim.ch/it/impianto-fotovoltaico-ginevra',
      },
    },
    openGraph: {
      ...
      url: 'https://solarheim.ch/fr/installation-solaire-geneve',
      type: 'website',
      locale: 'fr_CH',
      siteName: 'SolarHeim',
    },
            ...
            "itemListElement": [
              {
                ...
                "position": 1,
                "name": "Accueil",
                "item": "https://solarheim.ch/fr"
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Installation Solaire Genève",
                "item": "https://solarheim.ch/fr/installation-solaire-geneve"
              }
            ]
          })
        }}
